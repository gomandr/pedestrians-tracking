...
A trained model (PCB_MS2) on the MSMT17 dataset can be found here (requires EPFL account):
https://drive.google.com/open?id=19Y-yiTndiBKcrkYGZmXPwZD1rJ-iicaH

## Train
To train a new model, run for example the command :
